...
var ctx_m = canvas_m.getContext("2d");
var width = 0;
var height = 0;
var particles = [];
var particles = [];
...
var config = {
  minDropSize: pixelrain_config.minDropSize,
  maxDropSize: pixelrain_config.maxDropSize,
  windForce: pixelrain_config.windForce,
  particlesPerSplash: 2,
  dropsPerInterval: 10,
  dropInterval: 100,
  numParticles: pixelrain_config.numParticles,
  speed: pixelrain_config.speed
};
...
Particle.prototype.render = function(ctx) {
  ctx.fillStyle = "rgba(26,56,211,.8)";
  ctx.fillRect(this.x, this.y, this.size/2, this.size*8);
...
Particle.prototype.update = function(dt) {
  var g = (dt/1000) * 9.8 * config.speed * (this.size / 2);
